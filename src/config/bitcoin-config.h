...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The DiamondHands Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "DiamondHands Core"
...
#define PACKAGE_BUGREPORT "https://github.com/diamondhands-project/diamondhands/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "DiamondHands Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "DiamondHands Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "diamondhands"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://diamondhands.org/"
